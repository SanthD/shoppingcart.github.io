...
let ProductCreatingComponent = class ProductCreatingComponent {
    constructor(fb) {
        this.fb = fb;
...
ProductCreatingComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
];
...
let WhishlistComponent = class WhishlistComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ProdustsService = class ProdustsService {
    constructor(http) {
        this.http = http;
...
ProdustsService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }
];
